...
class SinaExtractorRoll(BaseExtractor):
 
    def __init__(self, config):
        super(SinaExtractorRoll, self).__init__(config)
...
#             link_list2 = driver.find_elements_by_css_selector("div[class=\"news-item\"]")
            link_list = driver.find_element_by_class_name("d_list_txt").find_elements_by_tag_name("li")
...
#                 link_list = main_section.find_elements_by_tag_name("h2")
            ...
            for elem in link_list:
                ...
                if title not in list:
                    ...
                    url = elem.find_element_by_class_name("c_tit").find_element_by_tag_name("a").get_attribute("href")
